                    ...
                    <div class="category-sidebar">
                        <div class="widget category-list">
                            ...
                            <ul class="category-list">
                                <li><a href="{{route('figureles.index')}}"> Visos </a></li>
                                @foreach ($tod->where('category_id',1)->unique('type_id') as $prod)
                                    @foreach($types->where('id', $prod->type_id)->unique() as $typez)
                                        <li><a href="{{route('figureles.index',['type' => $typez->id]) }}">{{$typez -> title}}</a></li>
                                    @endforeach
                                @endforeach
