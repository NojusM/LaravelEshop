                ...
                <div class="col-lg-3 col-md-4">
                    <div class="category-sidebar">
                        <div class="widget category-list">
                            <h4 class="widget-header">Kategorijos</h4>
                            <ul class="category-list">
                                <li><a href="{{route('atributika.index')}}"> Visos </a></li>
                                @foreach ($tod->where('category_id',2)->unique('type_id') as $prod)
                                @foreach($types->where('id', $prod->type_id)->unique() as $typez)
                                    <li><a href="{{route('atributika.index',['type' => $typez->id]) }}">{{$typez -> title}}</a></li>
                                @endforeach
                                @endforeach
                        ...
                        <div class="ad-listing-list mt-20">
                            <div class="row p-lg-3 p-sm-5 p-4">
                                <div class="col-lg-4 align-self-center">
                                    <a href="{{route('atributika.show', $item->title)}}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-10">
                                            <div class="ad-listing-content">
                                                <div>
                                                    <a href="{{route('atributika.show', $item->title)}}" class="font-weight-bold">{{ $item-> title }}</a>
                                                </div>
